function TransferSummary({ transfer = {}, bank = null, beneficiary = null }) {
  const formatAmount = () => {
    if (
    ...
    return `${Number(transfer.amount).toLocaleString("fr-FR", {
  ...
  return (
    <div className="transfer-summary">
      <div className="transfer-summary-header">
        <div>
          <span>RÉCAPITULATIF DU VIREMENT</span>
      ...
      <div className="transfer-summary-grid">
        ...
        <div className="summary-item">
          ...
          <strong>{bank?.name || transfer.bank_name || "—"}</strong>
        </div>

        <div className="summary-item">
          <span>Compte débiteur</span>

          <strong>{transfer.debit_account || "—"}</strong>
        </div>
        ...
        <div className="summary-item">
          ...
          <strong>{transfer.fees || "SHA"}</strong>
        </div>
        ...
        <div className="summary-item">
          ...
          <strong>
            {beneficiary?.iban || transfer.beneficiary_iban || "—"}
          </strong>
        </div>
        ...
        <div className="summary-item">
          ...
          <strong>
            {beneficiary?.swift || transfer.beneficiary_swift || "—"}
          </strong>
        </div>
      </div>

      {(transfer.purpose || transfer.case_reference) && (
