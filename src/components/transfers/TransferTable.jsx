...
function TransferTable({ transfers = [], loading = false, onDelete, onView }) {
      ...
      <table className="data-table transfer-table">
        ...
        <tbody>
          {transfers.map((transfer) => (
            <tr key={transfer.id}>
              <td>
                <span className="table-primary">{transfer.reference}</span>
              </td>

              <td>{formatDate(transfer.transfer_date)}</td>

              <td>
                <span className="table-primary">{transfer.bank_name}</span>
