...
export const getBeneficiaries = async () => {
  const response = await api.get("/beneficiaries/getBeneficiaries");

  return response.data;
};

export const getOneBeneficiary = async (id) => {
  const response = await api.get(`/beneficiaries/getOneBeneficiary/${id}`);
...
export const deleteBeneficiary = async (id) => {
  const response = await api.delete(`/beneficiaries/deleteBeneficiaries/${id}`);
